...
var Scrollama = /*#__PURE__*/function (_Component) {
  ...
  function Scrollama(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "viewH", typeof window !== 'undefined' ? window.innerHeight : 0);
    ...
    React__default['default'].Children.forEach(children, function (_, idx) {
      var childId = "react-scrollama-".concat(idx);
      _this[childId] = /*#__PURE__*/React__default['default'].createRef();
  ...
  _createClass(Scrollama, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default['default'].createElement(React.Fragment, null, this.isDebug && /*#__PURE__*/React__default['default'].createElement(DebugOffset, {
        offsetMargin: this.state.offsetMargin,
        offsetVal: this.offsetVal
      }), React__default['default'].Children.map(this.props.children, function (child, index) {
...
var Step = /*#__PURE__*/function (_Component) {
  ...
  function Step() {
    ...
    _defineProperty(_assertThisInitialized(_this), "nodeRef", /*#__PURE__*/React__default['default'].createRef());
